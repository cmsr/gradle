...
public class DefaultTransformationRegistration implements VariantTransformRegistry.Registration {
            ...
            propertyWalker.visitProperties(isolatedParameterObject.isolate(), new PropertyVisitor.Adapter() {
                ...
                public void visitInputProperty(String propertyName, PropertyValue value, boolean optional) {
                    try {
                        ...
                        Object normalizedValue = normalizeValue(unpacked);
                        inputPropertyFingerprints.put(propertyName, valueSnapshotter.snapshot(normalizedValue));
                    } catch (Throwable ex) {
    ...
    private static Object normalizeValue(Object unpacked) {
